...
public class PersonTableModel  extends AbstractTableModel {
	...
	private Object[][] objArray = this.getPerson(); //Create a new instance from our proxy, so we can get access to the list of object[].
	...
	public Object[][] getPerson(){ //Method that calls our method getTableAsList() via proxy in webservice. In the Controller
		...
		try { //we surround with try/catch when we make calls to our webservice.
			return soapProxy.getTableAsList("Person"); //Call the table: Person. 
